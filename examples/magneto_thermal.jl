...
add_operation!(
	...
	comment = " You may restrict DomainC_Mag to part of it",
)
add_operation!(
	op2,
...
add_operation!(
	...
	comment = " Region to adapt according to your cable",
)
add_operation!(
	op2,
...
add_operation!(
	op3,
	"Print[ TinC, OnElementsOf Region[{Vol_Thermal,-Cable}], Smoothing 1, Name \"T [°C] araound cable\",  File \"T.pos\" ];",
)
add_operation!(
	op3,
	"Print[ TinC , OnElementsOf Cable,  Name \"T [°C] Cable\", File \"T_cable.pos\" ];",
)
add_operation!(
	op3,
	"Print[ q , OnElementsOf Region[{Vol_Thermal,-Cable}], Name \"heat flux [W/m²] around cable\",  File \"q.pos\" ];",
)
add_operation!(
	op3,
	"Print[ q , OnElementsOf Cable, Name \"heat flux [W/m²] cable\",  File \"q_cable.pos\" ];",
)
