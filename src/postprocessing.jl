...
"""
function add!(postprocessing::PostProcessing, name::String, NameOfFormulation::String; comment=nothing, kwargs...)
    item = PostproItem(name; NameOfFormulation=NameOfFormulation, comment=comment, kwargs...)
